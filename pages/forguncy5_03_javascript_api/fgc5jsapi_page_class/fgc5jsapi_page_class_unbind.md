...
### Page - Unbind Method
page.unbind (type, data, fn, targetPage)
<br /><br />

### Unbind Method 설명
특정 페이지에 이벤트들을 unbind합니다. 현재 화면에 보이는 페이지, 지정한 특정 페이지 혹은 모든 페이지에 이벤트를 bind할 수 있습니다.
<br /><br />
...
### 활용 예제
아래는 page.unbind를 사용하는 예제입니다. 다음 예제들을 응용하여 페이지 내에서 작동하는 이벤트를 Bind 할 수 있습니다.
<br />
