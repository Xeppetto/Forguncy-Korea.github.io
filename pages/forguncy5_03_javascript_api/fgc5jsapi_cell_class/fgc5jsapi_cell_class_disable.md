---
title: Forguncy JavaScript API - Cell - disable
tags: [Forguncy, JavaScript, API]
keywords: Forguncy API, JavaScript API, disable, Web, JavaScript, API
last_updated: Jan 16, 2020
summary: "Forguncy JavaScript API - Cell 클래스 중 disable Method를 설명합니다."
